...
namespace Project2
{
    ...
    {
        WindowsFormsApp5.Validate validate = new WindowsFormsApp5.Validate();
        public Register()
        {
            InitializeComponent();
        }
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                pictureBox1.Image = WindowsFormsApp5.Properties.Resources.design_a;
            } else if (comboBox1.Text == "Modelo Covenant")
            {
                pictureBox1.Image = WindowsFormsApp5.Properties.Resources.design_b;
            } else
            {
                pictureBox1.Image = WindowsFormsApp5.Properties.Resources.design_c;
            }
        }
